...
model = AutoModelForSequenceClassification.from_pretrained('/home/anca/Fac/MT/System1/checkpoints/9.pth')
model.to(device)
model.eval()

dev = pd.read_csv('/home/anca/Fac/MT/System1/posts_test.csv')

dev_texts = dev.post.values
dev_labels = dev.class_id.values
...
print(accuracy_score(pred_flat, dev_labels))
print(len(pred_flat))