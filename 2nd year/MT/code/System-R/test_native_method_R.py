...
model = AutoModelForSequenceClassification.from_pretrained('/home/anca/Fac/MT/System-R/checkpoints/1.pth')
model.to(device)
model.eval()


dev = pd.read_csv('/home/anca/Fac/MT/test dataset/russian.csv')
