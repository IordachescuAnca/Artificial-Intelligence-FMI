...
model = AutoModelForSequenceClassification.from_pretrained('/home/anca/Fac/MT/System-J/checkpoints/4.pth')
model.to(device)
model.eval()

dev = pd.read_csv('/home/anca/Fac/MT/test dataset/japanese.csv')
