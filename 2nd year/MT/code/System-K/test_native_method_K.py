...
model = AutoModelForSequenceClassification.from_pretrained('/home/anca/Fac/MT/System-K/checkpoints/8.pth')
model.to(device)
model.eval()


dev = pd.read_csv('/home/anca/Fac/MT/test dataset/korean.csv')
